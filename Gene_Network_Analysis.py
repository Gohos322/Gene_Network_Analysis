...
AllData = np.genfromtxt("insert hera 4-way data RNA-seq matrix", delimiter='\t', dtype=None, encoding=None)
#extract the patient barcodes from the 4-way-data patients list
listPN = np.genfromtxt("Insert here a 4-way data control patient list", delimiter='\n', dtype=None, encoding=None)
listPC = np.genfromtxt("Insert here a 4-way data cancer patient list", delimiter='\n', dtype=None, encoding=None)
...
plt.scatter(x,y)
plt.title("Betweeness Centrality of SGN")
plt.xlabel("Nodes")
plt.ylabel("Values")
plt.show()
...
x, y = zip(*lists) # unpack a list of pairs into two tuples
plt.scatter(x,y)
plt.title("Betweeness Centrality of SGC")
plt.xlabel("Nodes")
plt.ylabel("Values")
plt.show()
...
x, y = zip(*lists) # unpack a list of pairs into two tuples
plt.scatter(x,y)
plt.title("Degree Centrality of SGN")
plt.xlabel("Nodes")
plt.ylabel("Values")
plt.show()
...
x, y = zip(*lists) # unpack a list of pairs into two tuples
plt.scatter(x,y)
plt.title("Degree Centrality of SGC")
plt.xlabel("Nodes")
plt.ylabel("Values")
plt.show()
...
x, y = zip(*lists) # unpack a list of pairs into two tuples
plt.scatter(x,y)
plt.title("Closeness Centrality of SGN")
plt.xlabel("Nodes")
plt.ylabel("Values")
plt.show()
...
x, y = zip(*lists) # unpack a list of pairs into two tuples
plt.scatter(x,y)
plt.title("Closeness Centrality of SGC")
plt.xlabel("Nodes")
plt.ylabel("Values")
plt.show()
...
plt.text(0.05, 0.95, textstr, fontsize=8, verticalalignment='top', bbox=props)
plt.show()
